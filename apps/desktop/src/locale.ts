...
export const en = {
  ...
  mcpMarketMenu: 'MCP Marketplace…',
  mcpMarketMenuPackagedOnly: 'MCP Marketplace… (available in packaged applications)',
  ...
  mcpMarketTitle: 'MCP Marketplace',
  mcpMarketWindowTitle: 'DeepSeek Harness — MCP Marketplace',
  mcpMarketDescription: 'Search the official MCP Registry. One-click connections are limited to HTTPS Streamable HTTP MCP servers that require no extra credentials.',
  mcpSearchLabel: 'Search the official MCP Registry',
  mcpSearchPlaceholder: 'GitHub, database, browser…',
  search: 'Search',
  mcpDiscover: 'Discover',
  mcpEmpty: 'No MCP servers matched this search.',
  mcpInstalled: 'Installed MCP servers',
  mcpInstalledEmpty: 'No MCP servers are installed.',
  mcpNoDescription: 'No description was supplied by the registry.',
  mcpOneClick: 'One-click connection',
  mcpSetupRequired: 'Requires manual setup',
  mcpRegistryOnly: 'Official MCP Registry',
  mcpAdd: 'Add to DeepSeek Harness',
  mcpAdding: 'Adding {name}…',
  mcpRemoving: 'Removing {name}…',
  mcpLoading: 'Loading the MCP Registry…',
  mcpSearching: 'Searching the MCP Registry…',
  mcpRefreshing: 'Refreshing the MCP Registry…',
  mcpRefreshed: 'MCP Registry refreshed.',
} as const
...
export const zh = {
  ...
  mcpMarketMenu: 'MCP 市场…',
  mcpMarketMenuPackagedOnly: 'MCP 市场…（打包应用中可用）',
  ...
  mcpMarketWindowTitle: 'DeepSeek Harness — MCP 市场',
  mcpMarketDescription: '搜索官方 MCP Registry。仅无需额外凭据的 HTTPS Streamable HTTP MCP 支持一键连接。',
  mcpSearchLabel: '搜索官方 MCP Registry',
  mcpSearchPlaceholder: 'GitHub、数据库、浏览器……',
  search: '搜索',
  mcpDiscover: '发现',
  mcpEmpty: '没有匹配的 MCP 服务器。',
  mcpInstalled: '已安装 MCP 服务器',
  mcpInstalledEmpty: '还没有安装 MCP 服务器。',
  mcpNoDescription: '该服务器未在 Registry 中提供说明。',
  mcpOneClick: '支持一键连接',
  mcpSetupRequired: '需要手动配置',
  mcpRegistryOnly: '官方 MCP Registry',
  mcpAdd: '添加到 DeepSeek Harness',
  mcpAdding: '正在添加 {name}…',
  mcpRemoving: '正在移除 {name}…',
  mcpLoading: '正在加载 MCP Registry…',
  mcpSearching: '正在搜索 MCP Registry…',
  mcpRefreshing: '正在刷新 MCP Registry…',
  mcpRefreshed: 'MCP Registry 已刷新。',
